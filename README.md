...
* **Backend:** [Laravel 11.x](https://laravel.com) (PHP 8.2+) — Sebagai core API & business logic.
* **Frontend:** [Nuxt 3.x](https://nuxt.com) (Vue 3 & TypeScript) — Sebagai Web UI Utama/User Interface.
