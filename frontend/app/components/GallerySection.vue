<template>
    ...
    >
        ...
        <UModal v-model:open="lightboxOpen" fullscreen>
            <template #content>
                <div
                    class="relative w-full h-full bg-black/95 flex flex-col items-center justify-center"
                ...
                >
                    ...
                    <div v-if="lightboxCurrent" class="mt-4 text-center px-8">
                        <p class="text-white font-semibold text-lg">
                            {{ titleOf(lightboxCurrent) }}
                        </p>
                        <p class="text-white/60 text-sm mt-1">
                            {{ descOf(lightboxCurrent) }}
                        </p>
...
const lightboxCurrent = computed(
    () => previewItems.value[lightboxIndex.value] ?? null,
);
