<template>
    ...
    >
        <!-- Decorative blobs -->
        <div
            class="absolute -top-20 left-0 w-72 h-72 bg-emerald-400/10 dark:bg-emerald-500/5 rounded-full blur-3xl pointer-events-none"
        ></div>
        <div
        ...
        >
            ...
            >
                <div
                    v-for="n in 3"
                    :key="n"
                    class="rounded-3xl overflow-hidden border border-emerald-100 dark:border-emerald-900/50"
                >
            ...
            >
                ...
                >
                    ...
                    <div class="relative aspect-[16/9] overflow-hidden">
                        ...
                        <div
                            v-else
                            class="w-full h-full bg-emerald-100 dark:bg-emerald-900/60 flex items-center justify-center"
                        >
                            <UIcon
                        ...
                        ></div>
                        <span
                            class="absolute top-4 left-4 px-3 py-1 rounded-full text-xs font-bold bg-amber-400/90 text-emerald-950"
                        >
                    ...
                    <div class="p-5">
                        <h3
                            class="text-xl font-serif font-bold text-slate-900 dark:text-emerald-50 line-clamp-2 leading-snug mb-2 group-hover:text-emerald-700 dark:group-hover:text-amber-300 transition-colors"
                        >
                            {{ titleOf(previewArticles[0]) }}
                        </h3>
                        <p
                            class="text-sm text-slate-500 dark:text-emerald-200/60 line-clamp-3 leading-relaxed"
                        >
                            {{ stripHtml(contentOf(previewArticles[0])) }}
                        </p>
                        <div
                            class="mt-4 flex items-center gap-1 text-sm font-semibold text-emerald-600 dark:text-emerald-300"
                        >
                            <span>{{
                                locale === "en"
                                    ? "Read more"
                ...
                >
                    <!-- Image -->
                    <div
                        class="relative aspect-[16/9] overflow-hidden flex-shrink-0"
                    >
                        <NuxtImg
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        <h3
                            class="text-lg font-serif font-bold text-slate-900 dark:text-emerald-50 line-clamp-2 leading-snug mb-2 group-hover:text-emerald-700 dark:group-hover:text-amber-300 transition-colors"
                        >
                            {{ titleOf(article) }}
                        </h3>
                        <p
                            class="text-sm text-slate-500 dark:text-emerald-200/60 line-clamp-2 leading-relaxed flex-1"
                        >
