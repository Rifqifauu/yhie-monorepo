...
class ProgramController extends Controller
{
    ...
    public function show(Request $request, string $slug): JsonResponse
    {
        ...
        try {
            ...
            return response()->json(
                [
                    "message" =>
                        "Failed to fetch program detail. Please try again later.",
                ],
                500,
            );
        }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            if ($request->hasFile("image_path")) {
                $data["image_path"] = $this->storeProgramImage(
            ...
            return response()->json(
                [
                    "message" =>
                        "Failed to create program. Please try again later.",
                ],
                500,
            );
        }
    ...
    public function update(Request $request, Program $program): JsonResponse
    {
        ...
        if ($request->hasFile("image_path")) {
            $rules["image_path"] =
                "sometimes|image|mimes:jpeg,png,jpg,webp|max:2048";
        ...
        try {
            ...
            return response()->json(
                [
                    "message" =>
                        "Failed to update program. Please try again later.",
                ],
                500,
            );
        }
    ...
    public function destroy(Program $program): JsonResponse
    {
        try {
            ...
            return response()->json(
                [
                    "message" =>
                        "Failed to delete program. Please try again later.",
                ],
                500,
            );
        }
    ...
    private function storeProgramImage(
        $imageFile,
